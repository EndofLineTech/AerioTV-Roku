sub main()
    assertEqual(channelHeading("240", "240 | Freeform"), "240 | Freeform", "exact delimited prefix shown once")
    assertEqual(channelHeading("24", "240 | Freeform"), "24  240 | Freeform", "longer number is not the same prefix")
    assertEqual(channelHeading("24", "24Kitchen"), "24  24Kitchen", "genuinely numbered name preserved")
    assertEqual(channelHeading("24", "24 Hours"), "24  24 Hours", "space alone is not a number delimiter")
    assertEqual(channelHeading("2.1", "2.1 | Noticias"), "2.1 | Noticias", "decimal number and language preserved")
    assertEqual(channelHeading("", "Local News"), "Local News", "missing number preserves name")
