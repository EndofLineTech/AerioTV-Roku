...
**[Download v0.3.35 — testing prerelease](https://github.com/EndofLineTech/AerioTV-Roku/releases/tag/v0.3.35)**

Under **Assets**, download **`aeriotv-roku-v0.3.35.zip`**. Keep it zipped.
...
- **Guide mapping repair:** restores the `v0.3.8` paged EPG-link request so large
  Dispatcharr installations use authoritative mappings without one oversized Roku
  response. Guide diagnostics distinguish oversized responses from Roku memory
  pressure and report a safe threshold bucket when available.
...
[v0.3.35 release notes](docs/RELEASE-0.3.35.md)
...
| Feature | Roku — v0.3.35 preview | Apple TV — upstream | Android TV / Google TV — upstream |
| --- | --- | --- | --- |
...
Upstream comparison sources reviewed 2026-09-19; Roku column updated for v0.3.35:
...
1. Click **Upload** / **Choose File** and select **`aeriotv-roku-v0.3.35.zip`**.
