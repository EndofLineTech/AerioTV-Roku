...
**[Download v0.3.36 — testing prerelease](https://github.com/EndofLineTech/AerioTV-Roku/releases/tag/v0.3.36)**

Under **Assets**, download **`aeriotv-roku-v0.3.36.zip`**. Keep it zipped.
...
- **16 MB metadata response limit:** restores the `v0.3.8` default of 16,000,000
  ...
  was incorrect. Affected-account guide recovery still needs confirmation.
...
[v0.3.36 release notes](docs/RELEASE-0.3.36.md)
...
| Feature | Roku — v0.3.36 preview | Apple TV — upstream | Android TV / Google TV — upstream |
| --- | --- | --- | --- |
...
Upstream comparison sources reviewed 2026-09-19; Roku column updated for v0.3.36:
...
1. Click **Upload** / **Choose File** and select **`aeriotv-roku-v0.3.36.zip`**.
